...
import com.lishman.springdata.jpa.domain.Country;
...
public class CountryRepositoryTest {
    ...
    public void testReadByNameLike() {
        ...
        assertThat(startsWithGaOrGe.toString(), equalTo("[Germany, Georgia]"));
    }

    @Test
    public void testReadByNameContaining() {
        List<Country> startsWithGaOrGe = countryRepo.getByNameContaining("ia");
        assertThat(startsWithGaOrGe.toString(), equalTo("[Australia, Georgia, Gambia]"));
    }
    ...
    public void testReadByNameLikeQuery() {
        ...
        assertThat(startsWithGaOrGe.toString(), equalTo("[Gambia, Gabon]"));
    }
